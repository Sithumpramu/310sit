# parameters
ARG REPO_NAME="310sit"
ARG DESCRIPTION="Base class repo for UML EECE 5560"
ARG MAINTAINER="Sithum Pramuditha (sithumpramuditha2000@gmail.com)"
...
# define base image
FROM duckietown/${BASE_IMAGE}:${BASE_TAG} as BASE RUN apt-key adv --keyserver 'hkp://keyserver.ubuntu.com:80' --recv-key
